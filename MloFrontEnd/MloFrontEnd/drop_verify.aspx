<%@ Page Title="" Language="C#" MasterPageFile="~/warehouse.master" AutoEventWireup="true" CodeBehind="drop_verify.aspx.cs" Inherits="MloFrontEnd.drop_verify" %>
<asp:Content ID="Content1" ContentPlaceHolderID="WarehouseHead" runat="server">
    <title>Drop Verify</title><script>
